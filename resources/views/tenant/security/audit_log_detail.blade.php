<x-app-layout title="Audit Entry Inspection">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
      <div class="d-flex align-items-center gap-2 mb-1">
        <a href="{{ route('tenant.security.audit-logs') }}" class="btn btn-sm btn-outline-secondary">
          <i class="bi bi-arrow-left"></i> Back
        </a>
        <h1 class="h3 fw-bold mb-0">Audit Entry #{{ $log->id }}</h1>
        @php
    ...
    <div class="col-lg-4">
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-transparent fw-bold py-3 border-bottom">
          <i class="bi bi-info-circle me-1 text-primary"></i> Event Telemetry
        </div>
        <div class="card-body p-0">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
              <span class="text-muted small">Actor</span>
              <span class="fw-medium small">{{ $log->user ? $log->user->name : 'System / Automated' }}</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
    ...
    <div class="col-lg-8">
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-transparent fw-bold py-3 border-bottom d-flex justify-content-between align-items-center">
          <span><i class="bi bi-code-slash me-1 text-primary"></i> State Transitions (Diff)</span>
          <span class="badge bg-light text-secondary border font-monospace small">JSON Snapshot</span>
        </div>
        <div class="card-body p-3">
              ...
              <table class="table table-bordered align-middle mb-0">
                <thead class="table-light">
                  <tr>
                    ...
                    <th style="width: 37.5%;" class="text-danger">Previous Value (Old)</th>
                    <th style="width: 37.5%;" class="text-success">New Value (Updated)</th>
                  </tr>
                </thead>
                <tbody>
          ...
          @elseif(!empty($log->new_values))
            <h6 class="fw-bold text-success mb-2">Created State Attributes:</h6>
          ...
          @elseif(!empty($log->old_values))
            <h6 class="fw-bold text-danger mb-2">Deleted State Attributes:</h6>
