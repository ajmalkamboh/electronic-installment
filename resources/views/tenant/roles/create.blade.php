<x-app-layout title="Create Custom Role">
  <!-- Page Header -->
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
      ...
      <p class="text-muted mb-0">
        Define a specialized role with custom permission privileges tailored for your company.
      </p>
    </div>
  </div>
  ...
  <form method="POST" action="{{ route('roles.store') }}">
      ...
      <div class="card-body px-4 pb-4">
        <div class="row g-3">
          <div class="col-md-6">
            ...
            <input type="text" name="display_name" class="form-control @error('display_name') is-invalid @enderror" value="{{ old('display_name') }}" placeholder="e.g. Senior Auditor" required>
            @error('display_name')
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" placeholder="Brief explanation of functional responsibilities">
            @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h5 class="fw-bold mb-0"><i class="bi bi-key me-2 text-primary"></i>Assign Permissions</h5>
      <div class="btn-group">
            ...
            <div class="card-body p-3">
              @foreach($perms as $perm)
                <div class="form-check mb-2">
                  <input class="form-check-input perm-check perm-group-{{ $groupName }}" type="checkbox" name="permissions[]" value="{{ $perm->id }}" id="perm_{{ $perm->id }}" {{ is_array(old('permissions')) && in_array($perm->id, old('permissions')) ? 'checked' : '' }}>
    ...
    <div class="d-flex gap-2 mb-5">
      <button type="submit" class="btn btn-primary px-4 py-2 fw-semibold">
        <i class="bi bi-check2-circle me-1"></i>Save Custom Role
      </button>
